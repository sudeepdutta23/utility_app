    ...
    <View style={styles.container}>
      ...
      <View style={styles.wavesContainer}>
        <Svg width="100%" height="100">
          <Path
            d="M0,25 Q100,90 200,25 T450,25 L450,100 L0,100 Z"
            fill="white"
          />
        </Svg>
      </View>
  ...
  return (
    <View style={styles.mainContainer}>
      ...
      <View style={styles.btmContainer}>
        <Text style={styles.remembermeTxt}>Don't have account? </Text>
        <Text onPress={() => navigate('register')} style={styles.signupText}>
          Sign up
        </Text>
      </View>
    </View>
